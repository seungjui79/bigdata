...
# 마스크 선언 및 초기화
mask = np.full(shape=img5.shape, fill_value=9, dtype=np.uint8)
h, w, c = img5.shape
...
titles.append('subtarct')
titles.append('absdiff')
titles.append('bitwise_not')
titles.append('bitwise_and')

images=[img1,img2,img3,img4,img5,mask,ress[0],ress[1],ress[2],ress[3],ress[3],ress[4],ress[5]]
